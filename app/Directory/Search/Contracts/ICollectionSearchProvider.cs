...
namespace Biobanks.Search.Contracts
{
    ...
    /// </summary>
    public interface ICollectionSearchProvider
    {
        /// <summary>
        /// Search for Collection documents for a given ontology term, with specified facets
        ...
        /// <summary>
        /// Search for Collection documents in a given Organisation,
        ...
        BiobankCollectionResult Search(string organisationExternalId, string ontologyTerm, IEnumerable<SelectedFacet> selectedFacets);
