...
import { SimpleAlert } from "components/Alerts.jsx";
...
- Generating Client Credentials is covered in the [Directory Guide](../../directory-guide/bulk-submissions/api-credentials)
