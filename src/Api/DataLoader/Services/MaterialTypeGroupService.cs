...
{
    public class MaterialTypeGroupService : IDataLoadService
    {
        ...
        private async Task SubmitData(IList<string> data)
        {
            ...
            for (var i = 0; i < data.Count; i++)
            {
                ...
                var result = await Program.SendJsonAsync("MaterialTypeGroup", JsonConvert.SerializeObject(materialTypeGroup));
        ...
        private IEnumerable<string> PrepData()
        {
            ...
            var data = new ConfigurationBuilder()
                .AddJsonFile("StaticData/MaterialTypeGroup.json", optional: false)
                .Build();
