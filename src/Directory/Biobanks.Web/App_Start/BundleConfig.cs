...
namespace Biobanks.Web
{
    public static class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/adac/theme-config").Include(
                "~/Scripts/bootbox*",
                "~/Scripts/ADAC/adac-theme-config.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/shared").Include(
                ...
                "~/Scripts/Shared/fetch-wordpress-nav.js",
                "~/Scripts/Shared/footer-logos.js"));
