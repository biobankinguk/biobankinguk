...
namespace Biobanks.Web.Extensions
{
    public static class HttpPostedFilebaseExtensions
    {
        ...
        public static bool ValidateAs(this HttpPostedFileBase file, string[] validFormats)
        {
            ...
            {
                throw new FileFormatException("This file is not the correct format.");
            }

            if (file.ContentLength > 1000000)
            {
                throw new FileLoadException("Files must be less than 1Mb in size.");
            }

            return true;
        }

        public static bool ValidateImage(this HttpPostedFileBase file)
        {
            try
            {
                return ValidateAs(file, new[]
                    {
            ...
            {
                throw new BadImageFormatException("Images must be a valid GIF, JPEG or PNG file.");
            }
        }
