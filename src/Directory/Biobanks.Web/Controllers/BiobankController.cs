...
namespace Biobanks.Web.Controllers
{
    ...
    public class BiobankController : ApplicationBaseController
    {
        ...
        private async Task<Organisation> EditBiobankDetails(BiobankDetailsModel model)
        {
            ...
            {
                logoName = null;
                await _biobankWriteService.DeleteLogoAsync(model.BiobankId.Value);
            }
        ...
        public async Task<ActionResult> Edit(bool detailsIncomplete = false)
        {
            if (detailsIncomplete)
                SetTemporaryFeedbackMessage("Please fill in the details below for your sample resource. Once you have completed these, you'll be able to perform other administration tasks",
        ...
        public async Task<ActionResult> Edit(BiobankDetailsModel model)
        {
            ...
            SetTemporaryFeedbackMessage("Sample resource details updated!", FeedbackMessageType.Success);
        ...
        {
            var result = await _biobankWriteService.DeleteCollectionAsync(id);
