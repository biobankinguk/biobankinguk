...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgeRangeSampleSet", b =>
                {
                    b.Property<int>("AgeRangesId")
                        .HasColumnType("int");

                    b.Property<int>("SampleSetsId")
                        .HasColumnType("int");

                    b.HasKey("AgeRangesId", "SampleSetsId");

                    b.HasIndex("SampleSetsId");

                    b.ToTable("AgeRangeSampleSet");
                });
            ...
            modelBuilder.Entity("AgeRangeSampleSet", b =>
                {
                    b.HasOne("Biobanks.Entities.Data.ReferenceData.AgeRange", null)
                        .WithMany()
                        .HasForeignKey("AgeRangesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Biobanks.Entities.Data.SampleSet", null)
                        .WithMany()
                        .HasForeignKey("SampleSetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
