...
namespace Biobanks.Data.Migrations
{
    ...
    [Migration("20210324165742_OnlyOneNullUpperLowerAgeRange")]
    partial class OnlyOneNullUpperLowerAgeRange
    {
            ...
            modelBuilder.Entity("Biobanks.Entities.Data.ReferenceData.AgeRange", b =>
                {
                    ...
                    b.HasIndex("LowerBound", "UpperBound")
                        .IsUnique()
                        .HasFilter("[LowerBound] IS NOT NULL AND [UpperBound] IS NOT NULL");

                    b.ToTable("AgeRanges");

                    b.HasCheckConstraint("CK_ONLY_ONE_NULL", "[LowerBound] IS NOT NULL OR [UpperBound] IS NOT NULL");
                });
